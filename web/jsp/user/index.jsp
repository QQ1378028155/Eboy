        ...
        <body>
                ...
                <div id="templatemo_wrapper">
                        <div id="templatemo_header">
                                ...
                                <div id="site_title">
                                        <h1><a href="http://www.wzsky.net">Free CSS Templates</a></h1>
                                </div>

                                <div id="header_right">
                                        <a href="#">我的购物车</a> | <a href="#">结帐</a>
                                </div>
                        ...
                        <div id="templatemo_menu">
                                <div id="top_nav" class="ddsmoothmenu">
                                        <ul>
                                                ...
                                                <li><a href="products.html">订单管理</a>
                                                </li>
                                ...
                                <div id="menu_second_bar">
                                        <div id="top_shopping_cart">
                                                购物车： <strong id="cartSize"></strong> ( <a href="#">进入购物车</a> )
                                        </div>
                                        <div id="templatemo_search">
                                                <form action="#" method="get">
                                                        ...
                                                        <input type="submit" name="Search" value="搜索 " alt="搜索" id="searchbutton" title="轻松" class="sub_btn"  />
                                                </form>
                                        </div>
                                        <div class="cleaner"></div>
                                </div>
                                        ...
                                        <div class="details_wrapper">
                                                ...
                                                <div class="details">
                                                        ...
                                                        <div class="detail">
                                                                ...
                                                                <p><a href="http://www.wzsky.net/">Station Shop</a> is free css template provided by <a href="http://www.wzsky.net/">wzsky.net</a> for your personal or commercial websites. Sed aliquam arcu. Donec urna massa, cursus et mattis at, mattis quis lectus. </p>
                        ...
                        <div id="templatemo_footer">
                                <p>
                                        <a href="index.html">首页</a> | <a href="products.html">订单</a> | <a href="faqs.html">FAQs</a> | <a href="checkout.html">结帐</a> | <a href="contact.html">联系我们</a>
                                </p>

                                Copyright © 2048 <a href="#">Eboy</a> | <a href="http://www.wzsky.net" target="_parent">Website Templates</a> by <a href="http://www.wzsky.net" target="_parent">Free CSS Templates</a>
