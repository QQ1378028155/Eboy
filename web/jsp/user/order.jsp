            ...
            <div class="wraper">
                ...
                <div style='padding: 0 0 0 20px;width:690px;float:right;'>
                    <div align='center'>
                        <form>
                            订单号:
                            <input type="text"  style="width:200px;" id="orderId" name="orderReceiver"  class='text_field'/>&nbsp;&nbsp;&nbsp;
                            <p style="display: none;" id="authOrderId"></p>
                            密钥:
                            <input type="text"  style="width:200px;" id="orderValidate" name="orderReceiver" class='text_field'/>&nbsp;&nbsp;&nbsp;
                            <input type="submit" value=" 查询 " onclick="getOrder();return false;" name="CheckOrder"  alt="CheckOrder" id="checkorderbutton" title="查询订单" class="btn_m"  />
                        </form>
