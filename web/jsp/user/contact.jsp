...
<html>
        <head>
                ...
                <script type="text/javascript">
                        ...
                        {
                                document.getElementById('content').innerHTML = "<h1>联系我们</h1><div style='padding:10px;border:1px solid #ccc;'><strong>地址:</strong>上海市闵行区东川路800号<br /><strong>邮编:</strong>200240<br /><strong>电话:</strong>54749999<br /><strong>邮箱:</strong> <a href='mailto:Eboy@sjtu.edu.cn'>Eboy@sjtu.edu.cn</a><br /></div><div style='height:30px;'></div>";
                        }
                </script>
                <script type="text/javascript">
                        function guanfangwuliu()
                        {
                                document.getElementById('content').innerHTML = "<h1>官方物流</h1><img src='images/eyoubaologo.png'></img><br></br><h4>E邮宝</h4><div style='padding:10px;border:1px solid #ccc;'><p><strong> 国际e邮宝是中国邮政为适应国际电子商务寄递市场的需要，为中国寄件人推出全新国际邮递产品。该业务将致力于为eBay中国寄件人提供发向美国、澳洲等国家的包裹寄递服务。</strong></p></div><br/><img src='images/eyoubao.png'></img><br></br><br></br><img src='images/shunfenglogo.png'></img><br></br><h4>顺丰速运</h4><div style='padding:10px;border:1px solid #ccc;'><p><strong>顺丰速运（集团）有限公司作为一家主要经营国际、国内快递业务的港资快递企业，为广大客户提供快速、准确、安全、经济、优质的专业快递服务。</strong></p><li>顺丰以“成就客户，推动经济，发展民族速递业”为自己的使命，积极探索客户需求，不断推出新的服务项目，为客户的产品提供快速、安全的流通渠道。</li><li>为了向客户提供更便捷、更安全的服务，顺丰速运网络全部采用自建、自营的方式。经过十几年的发展，顺丰已经拥有6万多名员工和4000多台自有营运车辆,30多家一级分公司，2000多个自建的营业网点，服务网络覆盖20多个省、直辖市和香港、台湾地区，100多个地级市。</li></div><div style='height:30px;'></div>";
                        }
                </script>
                <script type="text/javascript">
                        function cishanbangzhu()
                        {
                                document.getElementById('content').innerHTML = "<h1>慈善帮助</h1><div style='background:url(images/charity_bg.jpg)'><object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0' width='900' height='300'><param name='movie' value='images/index.swf'><param name='quality' value='high'><param name='wmode' value='transparent'><embed src='images/index.swf' width='700' height='150' quality='high' pluginspage='http://www.macromedia.com/go/getflashplayer' type='application/x-shockwave-flash' wmode='transparent'></object></div><br></br><h2>慈善计划</h2><div style='padding:10px;border:1px solid #ccc;'><h4>我们将营业的1%拿出来作为eboy慈善基金</h4><p><strong>当遇到重大自然灾害的时候第一时间进行物资援助</strong></p><p><strong>援建落后地区的希望小学</strong></p><p><strong>每年结对10名贫困地区的儿童，帮助他们完成学业</strong></p></div><div style='height:30px;'></div>";
                        }
                </script>
                <script type="text/javascript">
                        function yuanjing()
                        {
                                document.getElementById('content').innerHTML = "<h1>愿景</h1><div style='padding:10px;border:1px solid #ccc;'><p><strong>eboy电子商务系统致力为中国用户屏蔽在其他市场(如英国/美国)购买物品时由语言/文化/海关/运输/税带来的障碍,使得中国用户也能够自如地在eBay上购买来自全球市场的商品。</strong></p><p><strong>我们的目标是：</strong></p><li>让海外购物变得简单又放心。</li><p><strong>我们的愿景是:</strong></p><li>通过整合优化低效率运作的国际物流资源和全球零售供应链来促进在线零售的全球化进程</li><li>改造中间环节多，库存过高，市场门槛高的传统代理制跨国零售模式。</li></div><br></br><img src='images/yuanjing.png'><div style='height:30px;'></div>";
                        }
                </script>
        </head>
        <body>
