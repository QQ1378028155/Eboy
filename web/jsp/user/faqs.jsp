                    ...
                    <div class="sidebar_box"><span class="bottom"></span>
                        ...
                        <div class="content">
                            <ul class="sidebar_list">
                                <li class="first"><a href="javascript:void(0)" onclick="changjianwenti()">常见问题</a></li>
                                <li class="last"><a href="javascript:void(0)" onclick="gouwuliucheng()">购物流程</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar_box"><span class="bottom"></span>
                        ...
                        <div class="content">
                            <ul class="sidebar_list">
                                <li class="first"><a href="javascript:void(0)" onclick="anquanfukuan()">安全付款</a></li>
                                <li><a href="javascript:void(0)" onclick="peisongfangshi()()">配送方式</a></li>
                                <li class="last"><a href="javascript:void(0)" onclick="huaiguantongguanfuwu()">海关通关服务</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar_box"><span class="bottom"></span>
                        ...
                        <div class="content">
                            <ul class="sidebar_list">
                                <li class="first"><a href="javascript:void(0)" onclick="zifeijisuanqi()">中国邮政国际资费计算器</a></li>
                                <li class="last"><a href="javascript:void(0)" onclick="qushuchaxun()">中国邮政区属查询</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
