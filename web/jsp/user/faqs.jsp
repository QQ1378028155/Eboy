...
<html>
        <head>
                ...
                <script type="text/javascript">
                        ...
                        {
                                document.getElementById("content").innerHTML = "<h1>购买商品流程</h1><br></br><p>eboy的购物过程非常简单，和京东、淘宝等电商网站基本相同，同时还提供担保交易功能，货物抵达您的手中并确认收货后，资金才会放款至卖家账户，安全交易有保障。</p><br></br><img src ='images/processtobuy.png' width='670' height='160'></img><div class='cleaner h20'></div>";
                        }
                </script>
                <script type="text/javascript">
                                ...
                                <div id="content">
                                        ...
                                        <div class="faq_list">
                                                <ul class="filter">
                                                        ...
                                                        <li class="business"><a href="#business">费用问题</a></li>
                                                        <li class="technical"><a href="#technical">安全问题</a></li>
                                                </ul>
                                                <ul id="faq">
                                                        <li class="all technical">
                                                                <p class="question">eboy上买到的都是正品吗？</p>
                                                                <div class="answer">
                                                                        <p>首先商品均采购自美国，商品来源正宗，品质有保障；其次买手都是长期居住在美国，并且经过身份、居住地址和个人信用信息的严格认证。美国完善的个人信用体系、严谨的法治环境，以及洋码头美国分公司背后强大的律师团队，任何售假、欺诈行为都要承担触犯美国法律的严厉后果。</p>
                                                                </div>
                                                        </li>
                                                        <li class="all technical">
                                                                <p class="question">eboy上销售的商品为什么这么便宜？</p>
                                                                <div class="answer">
                                                                        <p>码头上的商品均采购自eBay高信用的卖家，商品来源正宗；且国外的商业竞争充分，税费都较低所以商品售价低于国内。比如说，飞利浦7340剃须刀美国网站采购价少于60美元,同款商品在中国商场销售的市场价为700元；倩碧黄油美国专柜价格少于30美元,同款商品国内专柜售价为460元。</p>
                                                                </div>
                                                        </li>
                                                        <li class="all business">
                                                                <p class="question">代购商品怎么计费？</p>
                                                                <div class="answer">
                                                                        <p>代购商品除商品售价外通常还包含服务费、消费税、官网运费、国际运费、运输保险、关税等。通常情况关税需要您自理，但是在eboy，我们会将这些问题一并为您解决，所有费用包含在到手价和运费里。关税和代购费率我们会在价格清单上详细标明。</p>
                                                                </div>
                                                        </li>
                                                        <li class="all business">
                                                                <p class="question">关税怎么算？</p>
                                                                <div class="answer">
                                                                        <p>通常在店铺中会说明关于关税的相关事宜，如果没有可以参考我们提供的相关资料。</p>
                                                                </div>
                                                        </li>
                                                        <li class="all business">
                                                                <p class="question">运费怎么算？</p>
                                                                <div class="answer">
                                                                        <p>物流运费一般是基于购买件数或重量收取。（详情请查看“物流运费”）</p>
                                                                </div>
                                                        </li>
                                                        <li class="all business">
                                                                <p class="question">我付人民币还是美金？</p>
                                                                <div class="answer">
                                                                        <p>您支付时用人民币即可。eboy和国内领先的支付平台—支付宝合作，提供安全快捷的支付体验,所以您需要先申请支付宝账号。</p>
                                                                </div>
                                                        </li>
                                                        <li class="all technical">
                                                                <p class="question">我能退货吗？</p>
                                                                <div class="answer">
                                                                        <p>签收包裹前，若您发现收到的物品受损、丢失、数量不够、物品不相符的情况，务必拒签并立即和买手联系要求退货退款。</p>
                                                                </div>
                                                        </li>
                                                        <li class="all technical">
                                                                <p class="question">我付的货款安全吗？</p>
                                                                <div class="answer">
                                                                        <p>您所支付的所有货款在m我们发货后21天内在没得到您的确认/同意放款之前，我们是无法收到货款的。21天后您还没确认/同意放款系统会自动放款给我们eboy。如果遇包裹寄送延迟和商品与描述不符时请提前联系eboy客服继续冻结货款，以免造成损失。如果符合退货规则，您也可以申请退货，退款或者取消交易，在获得卖家同意的情况下，您的货款会退还给您。</p>
                                                                </div>
                                                        </li>
                                                </ul>
                                        </div>
